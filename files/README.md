...
| Dong Zi Han | Designed and implemented the Policy Analyzer & Conflict Detection module (dead rule detection, coverage gap analysis, audit chain verifier, role access matrix, policy dry-run diff). Set up the Docker deployment environment. Co-authored the project report. |
